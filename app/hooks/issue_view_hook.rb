module SerialNumberField
  class IssueViewHooks < Redmine::Hook::ViewListener
   ...
   render_on :view_expenses_form_details_bottom, :partial => 'remove_serial_number_field'
    render_on :view_expenses_bulk_edit_details_bottom, :partial => 'remove_serial_number_field'
  end
end
